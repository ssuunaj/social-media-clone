...
<div class="main_column column" id="main_column">
    ...
    if (mysqli_num_rows($query) == 0) {
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            echo "<b>".$user_from_obj->getName() ."</b>". " sent you a friend request";
            ...
            if (isset($_POST['accept_request' . $user_from])) {
                ...
                $delete_request_query = mysqli_query($conn, "DELETE FROM friend_requests WHERE user_to='$userLoggedIn' AND user_from='$user_from'");
