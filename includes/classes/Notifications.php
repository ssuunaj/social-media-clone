<?php
 ...
 public function getUnreadNumber(){
  ...
  public function insertNotification($post_id,$user_to,$type){
      ...
      $insert_query = mysqli_query($this->conn,"INSERT INTO notifications VALUES('','$user_to','$userLoggedIn','$message','$link','$dateTime','no','no')");
  }
  ...
  public function getNotifications($data, $limit){
    ...
    while($row = mysqli_fetch_array($query)){
      ...
      <div class='resultDisplay resultDisplayNotification' style='background-color:".$style."'>
