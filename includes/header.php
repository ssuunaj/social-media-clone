...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="assets/css/icons/css/all.css">
    ...
    <script>
        ...
        $(document).ready(function() {
            $(window).scroll(function() {
                var inner_height = $('.dropdown_data_window').innerHeight() //div containiing data
